...
/**
 * Class FabistronServiceProvider
 * @package Fabistron\Providers
 */
class FabistronServiceProvider extends ServiceProvider
{
    ...
    public function boot(Twig $twig, Dispatcher $dispatcher, ConfigRepository $config)
    {
        ...
        $enabledOverrides = explode(", ", $config->get("Fabistron.templates.override"));

        // Override partials
        $dispatcher->listen('IO.init.templates', function (Partial $partial) use ($enabledOverrides)
        {
            pluginApp(Container::class)->register('Fabistron::PageDesign.Partials.Header.NavigationList.twig', NavigationCacheSettings::class);
            pluginApp(Container::class)->register('Fabistron::PageDesign.Partials.Header.SideNavigation.twig', SideNavigationCacheSettings::class);
            ...
            {
                $partial->set('head', 'Fabistron::PageDesign.Partials.Head');
            }
        ...
        if (in_array("category_content", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('Fabistron::Category.Content.CategoryContent');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("checkout", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('Fabistron::Checkout.Checkout');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("order_confirmation", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('Fabistron::Checkout.OrderConfirmation');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("item", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('Fabistron::Item.SingleItem');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("my_account", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('Fabistron::MyAccount.MyAccount');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("cancellation_rights", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('Fabistron::StaticPages.CancellationRights');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("legal_disclosure", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('Fabistron::StaticPages.LegalDisclosure');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("privacy_policy", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('Fabistron::StaticPages.PrivacyPolicy');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("terms_conditions", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('Fabistron::StaticPages.TermsAndConditions');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("item_not_found", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('Fabistron::StaticPages.ItemNotFound');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("page_not_found", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('Fabistron::StaticPages.PageNotFound');
                return false;
            }, self::PRIORITY);
        }
    }
